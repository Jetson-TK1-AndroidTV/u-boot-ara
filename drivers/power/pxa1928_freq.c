...
struct pll_freq_tb pll3_freq_tb[] = {
	...
	},
	{
		...
		.post_div_sel = 2,
		/*
		 * for display 720p panel:
		 *     60*(720+48+80+48)*(1280+2+4+4)*24/4 = 4161024000
		 */
		.pll_clkout = 416000000,
		.diff_post_div_sel = 2,
		.pll_clkoutp = 416000000,
		.mystical_bit = 0,
	},
};
...
static int __pll_vco_setrate(int id, int subid)
{
	...
	if (PLL_OFFSET_EN && pll_freq->freq_offset_en) {
		/*
		 * enable freq offset
	...
	if (PLL_SSC_EN && pll_freq->fvco >= 1500000000UL) {
